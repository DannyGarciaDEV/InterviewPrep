...
// Waiting:The union of a Set containing values ["a", "b", "c"] and a Set containing values ["c", "d"] should return a new Set containing values ["a", "b", "c", "d"].
class Set {
    constructor() {
    ...
    union(otherSet) {
      ...
      // Add elements from the current set
      for (const element in this.dictionary) {
        unionSet.add(element);
      }
  
      // Add elements from the other set
      for (const element in otherSet.dictionary) {
        unionSet.add(element);
      }
