...
// Waiting:Your add method should not add duplicate values.
// Waiting:Your add method should return true when a value has been successfully added.
// Waiting:Your add method should return false when a duplicate value is added.
// Waiting:Your Set class should have a remove method.
// Waiting:Your remove method should only remove items that are present in the set.
// Waiting:Your remove method should remove the given item from the set.
// Waiting:Your Set class should have a size method.
// Waiting:The size method should return the number of elements in the collection.
