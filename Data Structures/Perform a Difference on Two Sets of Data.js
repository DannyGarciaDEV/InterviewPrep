...
// Passed:Your Set class should have a difference method.
// Passed:Your difference method should return the proper collection.
...
class Set {
    ...
    difference(set) {
      ...
      this.values().forEach(value => {
        // Check if the value is not in the other set
        if (!set.has(value)) {
          newSet.add(value);
        }
      });
